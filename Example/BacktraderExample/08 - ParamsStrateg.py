...
"""
Пример
https://www.youtube.com/watch?v=jJ9dE-uvlow&list=PLjEwgdnQO09V7Oj-0-Nc9a7ihI0kaq577&index=10"""
...
class TestStrategy(bt.Strategy):
		...
		def next(self):
				...
				if not self.position:
						...
						isSignalSell = len(self)-self.BarExecuted>=self.params.ExitBars # Прошло не мение 5-и баров с моментом входа в позицию
						if isSignalSell:
